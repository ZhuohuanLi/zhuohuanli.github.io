...
I study how language models resolve references to entities—both within text (**coreference resolution**) and against external knowledge bases (**entity linking**). Key contributions:
